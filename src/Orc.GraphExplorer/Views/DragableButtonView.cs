...
// -------------------------------------------------------------------------------------------------------------------
// <copyright file="DragableButtonView.cs" company="Orcomp development team">
...
namespace Orc.GraphExplorer.Views
{
    ...
    public class DragableButtonView : Button, IUserControl
    {
        ...
        public DragableButtonView()
        {
            _logic = new UserControlLogic(this, typeof(DragableButtonViewModel));
